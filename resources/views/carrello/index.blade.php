            ...
            <tbody>
                ...
                @foreach($elementi as $item)
                    ...
                    <tr style="border-bottom: 1px solid #eee;">
                        ...
                        <td style="padding: 15px; text-align: center;">@extends('layouts.app')
                    ...
                    <tr style="border-bottom: 1px solid #eee;">
                        ...
                        <td style="padding: 15px; text-align: center;">
                            <div style="display: flex; align-items: center; justify-content: center; gap: 10px;">
                                <form action="{{ route('carrello.aggiorna', $id_libro) }}" method="POST" style="margin: 0;">
                                    @csrf
                                    <input type="hidden" name="azione" value="meno">
                                    <button type="submit" style="background: #f1f2f6; border: 1px solid #ced4da; padding: 2px 8px; border-radius: 4px; cursor: pointer; font-weight: bold;">-</button>
                                </form>

                                <span style="font-weight: bold; min-width: 20px; display: inline-block;">{{ $item->quantita }}</span>

                                <form action="{{ route('carrello.aggiorna', $id_libro) }}" method="POST" style="margin: 0;">
                                    @csrf
                                    <input type="hidden" name="azione" value="piu">
                                    <button type="submit" style="background: #f1f2f6; border: 1px solid #ced4da; padding: 2px 8px; border-radius: 4px; cursor: pointer; font-weight: bold;">+</button>
                                </form>
                            </div>
                        </td>
